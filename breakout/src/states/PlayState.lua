                    ...
                    for k, brick in pairs(self.bricks) do
                        if brick.inPlay and ball:collides(brick) then
                            ...
                            if not brick:isLockedBrick() then
                                ...
                                -- Handle collision with locked brick
                                if self.hasKey then
                                    brick:destroy()
                                    self.hasKey = false
...
function PlayState:render()
    ...
    for k, brick in pairs(self.bricks) do
        if not brick:isLockedBrick() and brick.inPlay then
            brick:renderParticles()
            brick:render()
        elseif brick:isLockedBrick() and brick.inPlay then
            brick:render()
        end
    end
